...
const Banner = () => {
  return (
    <div className="relative">
      {/* <img src={banner} alt="" /> */}
      <div
        className="md:h-[600px] h-[450px] flex justify-center items-center bg-cover bg-center bg-no-repeat opacity-955 w-full object-fill"
        style={{ backgroundImage: `url(${banner})` }}
      >
        <div className="text-white opacity-100  text-center lg:w-4/12 md:w-8/12">
